    ...
    <div class="row"> 
            <div class="footer tc-padding-top">
                ...
                <div class="col-md-1 col-lg-1 col-sm-1">                                                                               
                    <div class="demo">
                        <a href="#">
                            <img class="" src="<?php echo $url_path ?>/images/img1.jpg" alt="">
                ...
                <div class="col-md-1 col-lg-1 col-sm-1">                                                                               
                    <div class="demo">
                        <a href="#">
                            <img class="" src="<?php echo $url_path ?>/images/img2.jpg" alt="">
                            <div class="overlay thumb"></div>
                            <div class="text thumb">
                                <i class="fa fa-search icon" aria-hidden="true"></i>
                            </div>
                ...
                <div class="col-md-1 col-lg-1 col-sm-1">                                                                               
                    <div class="demo">
                        <a href="#">
                            <img class="" src="<?php echo $url_path ?>/images/img3.jpg" alt="">
                            <div class="overlay thumb"></div>
                            <div class="text thumb">
                                <i class="fa fa-search icon" aria-hidden="true"></i>
                            </div>
                ...
                <div class="demo">
                    <a href="#">
                        <img class="" src="<?php echo $url_path ?>/images/img4.jpg" alt="">
                        <div class="overlay thumb"></div>
                        <div class="text thumb">
                            <i class="fa fa-search icon" aria-hidden="true"></i>
                        </div>
            ...
            <div class="col-md-1 col-lg-1 col-sm-1">                                                                               
                <div class="demo">
                    <a href="#">
                        <img class="" src="<?php echo $url_path ?>/images/img5.jpg" alt="">
                        <div class="overlay thumb"></div>
                        <div class="text thumb">
                            <i class="fa fa-search icon" aria-hidden="true"></i>
                        </div>
            ...
            <div class="col-md-1 col-lg-1 col-sm-1">                                                                               
                <div class="demo">
                    <a href="#">
                        <img class="" src="<?php echo $url_path ?>/images/img6.jpg" alt="">
                        <div class="overlay thumb"></div>
                        <div class="text thumb">
                            <i class="fa fa-search icon" aria-hidden="true"></i>
                        </div>
            ...
            <div class="col-md-1 col-lg-1 col-sm-1">                                                                               
                <div class="demo">
                    <a href="#">
                        <img class="" src="<?php echo $url_path ?>/images/img7.jpg" alt="">
                        <div class="overlay thumb"></div>
                        <div class="text thumb">
                            <i class="fa fa-search icon" aria-hidden="true"></i>
                        </div>
            ...
            <div class="col-md-1 col-lg-1 col-sm-1">                                                                               
                <div class="demo">
                    <a href="#">
                        <img class="" src="<?php echo $url_path ?>/images/img8.jpg" alt="">
                        <div class="overlay thumb"></div>
                        <div class="text thumb">
                            <i class="fa fa-search icon" aria-hidden="true"></i>
                        </div>
            ...
            <div class="col-md-1 col-lg-1 col-sm-1">                                                                               
                <div class="demo">
                    <a href="#">
                        <img class="" src="<?php echo $url_path ?>/images/img1.jpg">
                        <div class="overlay thumb"></div>
                        <div class="text thumb">
                            <i class="fa fa-search icon" aria-hidden="true"></i>
                        </div>
